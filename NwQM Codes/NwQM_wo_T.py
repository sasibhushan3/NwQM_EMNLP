''' This code implements the NwQM-w/oT model. (NwQM without Talk Pages)

    NwQM-w/oT model has 2 parts: Text page representation and Image (screenshot)
    representation. 
...
parser.add_argument('--batch_size', type=int, nargs='?', default=32,
                                        help='Training batch size for NwQM-w/oT model')
parser.add_argument('--learning_rate', type=float, nargs='?', default=0.01,
                                        help='Learning rate for NwQM-w/oT model')
...
print("model fitting - NwQM-w/oT Model")
model.fit([x_train,x_train_img], y_train, validation_data=([x_val,x_val_img], y_val),
...
print("Accuracy obtained using NwQM-w/oT model is : ",round(evaluate[1]*100,2))
print("Confusion Matrix of the results obtained using NwQM-w/oT model is :")
