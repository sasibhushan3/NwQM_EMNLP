''' This code Finetunes the BERT model on the Wikipedia data for getting better
    representation of the page.
 
    We tokenize the cleaned text for each page (into BERT readable format) and pass the
    tokenized input to BERT model and finetune the BERT model for 6 class classification
    to classify into 6 wikipedia classes and save the Finetuned model.
...
parser.add_argument('--num_epoch', type=int, nargs='?', default=3,
                                        help='Number of epochs for Finetuned BERT model')
parser.add_argument('--batch_size', type=int, nargs='?', default=16,
                                        help='Training batch size for Finetuned BERT model')
...
# Divide the data into train, val data
