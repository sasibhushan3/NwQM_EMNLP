''' This code implements the DocBERT model
    ...
    to classify into 6 wikipedia classes.
...
# train the model
print("model fitting - DocBERT Model")
...
y_pred = model.predict([test_input_ids, test_input_masks, test_segment_ids])
